<template>
  <div>
    ...
    >
      ...
      <el-table-column label="身份证号码" prop="cardId"> </el-table-column>
    ...
    <el-dialog :visible.sync="dialogVisible">
      <el-form :model="editTable" label-position="right" label-width="90px">
        ...
        <el-row>
          <el-col :span="10"
            ><el-form-item label="手机">
              <el-input v-model="editTable.tel"></el-input> </el-form-item
          ></el-col>
          <el-col :span="10" :offset="2"
            ><el-form-item label="邮箱">
              <el-input v-model="editTable.email"></el-input> </el-form-item
          ></el-col>
        </el-row>
        <el-row>
          <el-col :span="10"
          ...
          <el-col :span="10" :offset="2"
            ><el-form-item label="学历">
              <el-input v-model="editTable.education"></el-input> </el-form-item
          ></el-col>
        </el-row>
        <el-row>
          <el-col :span="10"
            ><el-form-item label="身份证号码">
              <el-input v-model="editTable.cardId"></el-input> </el-form-item
          ></el-col>
          <el-col :span="10" :offset="2"
            ><el-form-item label="所属部门">
